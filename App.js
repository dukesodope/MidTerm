...
import { Button, View, Text, ImageBackground, Image, StyleSheet, TouchableOpacity } from 'react-native';
    ...
    <ImageBackground source={require('./assets/background.jpg')} style={styles.background}>
      <View style={styles.container}>
        <View style={styles.content}>
          <Image source={require('./assets/carrot.jpg')} style={styles.icon} />
  ...
  return (
    ...
    marginLeft: 20,}}>with nectar</Text>
      <View style={styles.inputContainer}>
        <Image source={require('./assets/Icon.png')} style={styles.phoneIcon} />
